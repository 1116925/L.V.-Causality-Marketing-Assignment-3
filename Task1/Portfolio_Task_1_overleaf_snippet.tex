% =========================================================================
% Paste this block AFTER \tableofcontents and BEFORE \section{Portfolio task 2}.
% Sectioning matches the convention used for Tasks 2/3/4:
%   \section{Portfolio task 1} → \subsection → \subsubsection.
% Code blocks reuse the Shaded/Highlighting commands already defined in the
% preamble (AlertTok, NormalTok, FunctionTok, etc.). No extra packages needed.
% =========================================================================

\section{Portfolio task 1}
...
\subsection{Experiment, notation, and non-compliance}
...
\subsection{Heterogeneity in the treatment effect}
...
\subsubsection{The linear model is mechanically misspecified on this data}
...
\subsubsection{Binned estimates tell a different story}
...
\subsubsection{Algorithm-conditional interpretation}
...
\subsection{Profitability with uncertainty}
...
\subsection{Methods and inference}
...
\subsection{Threats to causal identification}
...
\subsection{Reflection on AI Use}
...
% End of Portfolio task 1 — \section{Portfolio task 2} follows.
